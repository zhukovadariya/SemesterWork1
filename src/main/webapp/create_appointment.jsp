...
<form action="/SemestrWork1/createAppointment" method="post">
    ...
    <div class="box">
        <label for="name">Select a procedure:</label>
        <select name="name" id="name" required>

            <c:forEach var="proceduresNames" items="${proceduresNames}">
                <option>${proceduresNames}</option>
            </c:forEach>
...
<%--            %>--%>
    ...
    <div class="box">
        <input type="submit" value="Сontinue">
    </div>
