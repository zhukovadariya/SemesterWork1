...
<%
    List<Appointment> appointments = (List<Appointment>) request.getAttribute("appointmentsadmin");
...
<table style="border-collapse: collapse; width: 100%; border: 2px solid #333;">
    ...
    <tr style="background-color: #fff; color: #333;">
        <td style="padding: 10px; border: 1px solid #333;"><%= appointment.getId() %></td>
        ...
        <td style="padding: 10px; border: 1px solid #333;"><%= appointment.getDoctorId() %></td>
        <td style="padding: 10px; border: 1px solid #333;"><%= appointment.getPatientId() %></td>
    </tr>
    <% } %>
</table>
